...
pub const fn buffer_element_format_size(format: BufferElementFormat) -> u32 {
    ...
    match format {
        ...
        BufferElementFormat::F16x9 => F16_SIZE * 9,
        BufferElementFormat::F16x16 => F16_SIZE * 16,
        BufferElementFormat::F32x9 => F32_SIZE * 9,
        BufferElementFormat::F32x16 => F32_SIZE * 16,
        BufferElementFormat::F64x9 => F64_SIZE * 9,
        BufferElementFormat::F64x16 => F64_SIZE * 16,
    }
}
