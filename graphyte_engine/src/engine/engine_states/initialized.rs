    ...
    fn into(mut self) -> EngineStateMachine<Running> {
        ...
        EngineStateMachine {
            ...
            state: Running {
                ...
                update_stages_runner: UpdateStagesRunner::new(SceneManager::default(), self.state.update_stages, self.state.render_stage_update_handlers, self.state.update_thread_resources, dispatch_system),
